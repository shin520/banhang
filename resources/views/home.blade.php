                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <p class="mb-0"><span class="col-orange">10%</span> Decrease</p>
                                        </div>
                                    </div>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Quốc gia</h5>
                                            <h2 class="mb-3 font-18">{{Country::count()}}</h2>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('admin') }}/img/users/user-1.png" class="user-img mr-2"
                                    alt="">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('admin') }}/img/users/user-2.png" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('admin') }}/img/users/user-3.png" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('admin') }}/img/users/user-6.png" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
