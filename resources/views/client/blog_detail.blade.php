                    ...
                    <div class="col-lg-9">
                        <article class="entry single-entry">
                            <figure class="entry-media">
                                <img src="{{ asset('client') }}/images/blog/single/1.jpg" alt="image desc">
                            ...
                            <div class="entry-body">
                                ...
                                <div class="entry-content editor-content">
                                    ...
                                    <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus
                                        ...
                                        Vestibulum volutpat, lacus a <a href="#">ultrices sagittis</a>, mi neque
                                    ...
                                    <img src="{{ asset('client') }}/images/blog/single/2.jpg" alt="image" class="float-left">
                                    ...
                                    <img src="{{ asset('client') }}/images/blog/single/3.jpg" alt="image">
                                    ...
                                    <p>Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget
                                        ...
                                        Sed lectus. Praesent <a href="#">elementum hendrerit</a> tortor. Sed semper
                            ...
                            <div class="entry-author-details">
                                <figure class="author-media">
                                    <a href="#">
                                        <img src="{{ asset('client') }}/images/blog/single/author.jpg" alt="User name">
                                    </a>
                        ...
                        <div class="related-posts">
                            ...
                            <div class="owl-carousel owl-simple" data-toggle="owl"
                                ...
                                <article class="entry entry-grid">
                                    <figure class="entry-media">
                                        <a href="single.html">
                                            <img src="{{ asset('client') }}/images/blog/grid/3cols/post-1.jpg" alt="image desc">
                                        </a>
                                    </figure><!-- End .entry-media -->
                                ...
                                <article class="entry entry-grid">
                                    <figure class="entry-media">
                                        <a href="single.html">
                                            <img src="{{ asset('client') }}/images/blog/grid/3cols/post-2.jpg" alt="image desc">
                                        </a>
                                    </figure><!-- End .entry-media -->
                                ...
                                <article class="entry entry-grid">
                                    <figure class="entry-media">
                                        <a href="single.html">
                                            <img src="{{ asset('client') }}/images/blog/grid/3cols/post-3.jpg" alt="image desc">
                                        </a>
                                    </figure><!-- End .entry-media -->
                                ...
                                <article class="entry entry-grid">
                                    <figure class="entry-media">
                                        <a href="single.html">
                                            <img src="{{ asset('client') }}/images/blog/grid/3cols/post-4.jpg" alt="image desc">
                                        </a>
                                    </figure><!-- End .entry-media -->
                            ...
                            <ul>
                                <li>
                                    <div class="comment">
                                        <figure class="comment-media">
                                            <a href="#">
                                                <img src="{{ asset('client') }}/images/blog/comments/1.jpg" alt="User name">
                                            </a>
                                        </figure>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="comment">
                                                <figure class="comment-media">
                                                    <a href="#">
                                                        <img src="{{ asset('client') }}/images/blog/comments/2.jpg" alt="User name">
                                                    </a>
                                                </figure>
                                ...
                                <li>
                                    <div class="comment">
                                        <figure class="comment-media">
                                            <a href="#">
                                                <img src="{{ asset('client') }}/images/blog/comments/3.jpg" alt="User name">
                                            </a>
                                        </figure>
