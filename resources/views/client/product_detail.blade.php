                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="{{ asset('client') }}/images/products/single/1.jpg"
                                            data-zoom-image="{{ asset('client') }}/images/products/single/1-big.jpg" alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        <a class="product-gallery-item active" href="#"
                                            data-image="{{ asset('client') }}/images/products/single/1.jpg"
                                            data-zoom-image="{{ asset('client') }}/images/products/single/1-big.jpg">
                                            <img src="{{ asset('client') }}/images/products/single/1-small.jpg" alt="product side">
                                        </a>

                                        <a class="product-gallery-item" href="#"
                                            data-image="{{ asset('client') }}/images/products/single/2.jpg"
                                            data-zoom-image="{{ asset('client') }}/images/products/single/2-big.jpg">
                                            <img src="{{ asset('client') }}/images/products/single/2-small.jpg" alt="product cross">
                                        </a>

                                        <a class="product-gallery-item" href="#"
                                            data-image="{{ asset('client') }}/images/products/single/3.jpg"
                                            data-zoom-image="{{ asset('client') }}/images/products/single/3-big.jpg">
                                            <img src="{{ asset('client') }}/images/products/single/3-small.jpg" alt="product with model">
                                        </a>

                                        <a class="product-gallery-item" href="#"
                                            data-image="{{ asset('client') }}/images/products/single/4.jpg"
                                            data-zoom-image="{{ asset('client') }}/images/products/single/4-big.jpg">
                                            <img src="{{ asset('client') }}/images/products/single/4-small.jpg" alt="product back">
                                        </a>
                            ...
                            <div class="product-details">
                                ...
                                <div class="details-filter-row details-row-size">
                                    ...
                                    <div class="product-nav product-nav-thumbs">
                                        <a href="#" class="active">
                                            <img src="{{ asset('client') }}/images/products/single/1-thumb.jpg" alt="product desc">
                                        </a>
                                        <a href="#">
                                            <img src="{{ asset('client') }}/images/products/single/2-thumb.jpg" alt="product desc">
                                        </a>
                                    </div><!-- End .product-nav -->
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-7 text-center">
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-nav product-nav-thumbs">
                                <a href="#" class="active">
                                    <img src="{{ asset('client') }}/images/products/product-4-thumb.jpg" alt="product desc">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('client') }}/images/products/product-4-2-thumb.jpg" alt="product desc">
                                </a>

                                <a href="#">
                                    <img src="{{ asset('client') }}/images/products/product-4-3-thumb.jpg" alt="product desc">
                                </a>
                            </div><!-- End .product-nav -->
                    ...
                    <div class="product product-7 text-center">
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-nav product-nav-thumbs">
                                <a href="#" class="active">
                                    <img src="{{ asset('client') }}/images/products/product-11-thumb.jpg" alt="product desc">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('client') }}/images/products/product-11-2-thumb.jpg" alt="product desc">
                                </a>

                                <a href="#">
                                    <img src="{{ asset('client') }}/images/products/product-11-3-thumb.jpg" alt="product desc">
                                </a>
                            </div><!-- End .product-nav -->
                        </div><!-- End .product-body -->
                    </div><!-- End .product -->
